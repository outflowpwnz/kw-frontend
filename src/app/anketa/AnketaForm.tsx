  ...
  const handleSubmit = async (e: FormEvent) => {
    ...
    try {
      await submitApplication({
        ...
        coupleName: form.couple_name || undefined,
        instagram: form.instagram,
        contact: form.contact,
        weddingDate: form.wedding_date || undefined,
        guestsCount: form.guests_count ? Number(form.guests_count) : undefined,
        budget: form.budget || undefined,
        venuePreferences: form.venue_preferences || undefined,
        hasCeremony: form.has_ceremony ? form.has_ceremony === 'да' : undefined,
        hasWalk: form.has_walk ? form.has_walk === 'да' : undefined,
        hasBuffet: form.has_buffet ? form.has_buffet === 'да' : undefined,
        stylistService: form.stylist_service || undefined,
        photographerService: form.photographer_service || undefined,
        videographerService: form.videographer_service || undefined,
        hostService: form.host_service || undefined,
        eveningEntertainment: form.evening_entertainment || undefined,
        decor: form.decor || undefined,
        vision: form.vision || undefined,
        noGo: form.no_go || undefined,
        otherWeddingsFeedback: form.other_weddings_feedback || undefined,
        howFound: form.how_found || undefined,
        preferredMeetingTime: form.preferred_meeting_time || undefined,
