...
const btnBase =
  'inline-flex items-center justify-center font-semibold transition-all duration-200 rounded-none cursor-pointer bg-[var(--color-orange)] text-white hover:opacity-90 active:opacity-80'
